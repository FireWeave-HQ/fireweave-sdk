...
Everything else a consumer touches is unchanged — see ADR-0007 and `test/compat/`. The consumer-facing migration guide is the [Node module README](../../sdks/node/packages/sdk/README.md#upgrading-from-v2-to-v3), which ships on the npm package page.
